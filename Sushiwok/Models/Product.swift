...
class ProductApi{
    ...
    [
        ...
        Product(
            ...
            grams: 1707, price: 1799
        ),
        Product(
            id: "5", image: "iskushenie", title: "Набор Искушение",
    ...
    [
        Product(
            id: "11", image: "wok-ostrij-s-govyadinoj", title:"Wok острый с говядиной",
        ...
        Product(
            id: "12", image: "wok-klassicheskij", title: "Wok классический",
    ...
    [
        Product(
            id: "16", image: "sushi-chuka", title:"Суши Чука",
            description: "водоросли чука, нори, рис 30 г",
            grams: 39, price: 99
        ),
        Product(
            id: "17", image: "sushi-ostrij-krab", title: "Суши Острый краб",
            description: "нори, рис, спайси соус, краб-крем 35 г",
            grams: 35, price: 99
        ),
        Product(
            id: "18", image: "sushi-spaysi-tori", title: "Суши Спайси Тори",
            description: "цыпленок, нори, рис, спайси соус 35 г",
            grams: 35, price: 99
        ),
        Product(
            id: "19", image:  "zapechennye-sushi-krab", title: "Запеченные Суши Краб",
            description: "нори, рис, яки соус, краб-крем 35 г",
            grams: 35, price: 99
        ),
        Product(
            id: "20", image:"zapechennye-sushi-ugor", title: "Запеченные Суши Угорь",
    ...
    [
        Product(
            id: "21", image: "drakon-mini-pitstsa-amer-20sm", title:"Дракон на пышном тесте 20 см",
        ...
        Product(
            id: "22", image:  "picca-drakon-30-sm", title: "Дракон на пышном тесте 30 см",
        ...
        Product(
            id: "23", image: "picca-petrovskaya-30-sm", title: "Петровская на пышном тесте 30 см",
        ...
        Product(
            id: "24", image: "picca-proshutto-fungi-30-sm", title: "Прошутто фунги на пышном тесте 30 см",
            description: "грибы шампиньоны, ветчина, сыр моцарелла, пицца-соус, пышное тесто 630 г",
            grams: 630, price: 499
        ),
        Product(
            id: "25", image: "picca-zhyulen-30-sm", title: "Жюльен на пышном тесте 30 см",
    ...
    var products:[[Product]]{
        get{
            return [sets, rolls, woks, sushi, sushi]
        }
    }
    
    func setFavorite(id:String){
        var products = [Product]()
        products.append(contentsOf: sets)
    }
}
